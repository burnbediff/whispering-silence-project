        ...
        >
          <div className="flex flex-col md:flex-row w-full h-full">
            <div className="relative w-full md:w-1/2 h-1/2 md:h-full flex items-center justify-center">
              ...
              />
              {/* fade right */}
              <div className="absolute inset-y-0 right-0 hidden md:block" style={{ width: "4px", background: "linear-gradient(to right, transparent, #171717)" }} />
              {/* fade left */}
              <div className="absolute inset-y-0 left-0 hidden md:block" style={{ width: "4px", background: "linear-gradient(to left, transparent, #171717)" }} />
              {/* fade top */}
              <div className="absolute inset-x-0 top-0" style={{ height: "4px", background: "linear-gradient(to top, transparent, #171717)" }} />
              {/* fade bottom */}
              <div className="absolute inset-x-0 bottom-0" style={{ height: "4px", background: "linear-gradient(to bottom, transparent, #171717)" }} />
            </div>
